...
| # | Decision | Status |
|---|---|---|
| [0001](0001-browser-as-rendering-engine.md) | Use the browser (Remotion) as the rendering engine | Accepted |
| [0002](0002-canonical-text-whisper-timing.md) | Merge canonical caption text with whisper word timestamps | Accepted |
| [0003](0003-config-driven-engine-data-split.md) | Split rendering engine from per-project data | Accepted |
